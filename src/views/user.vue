  ...
  export default {
    ...
    data() {
      return {
        ...
        historyTimer: null,
        mapTimer: null,
        paramsAppKey: 'USER_HDT6WC2Y8850',
        paramsAppKeyHistory: 'USER_HDT6WC2Y8850_HISTORY',
        paramsAppKeyMap: 'USER_HDT6WC2Y8850',
        echartsObj: {
          realtimeDom: null,
          historyDom: null,
          wordMapDom: null
    ...
    methods: {
      ...
      // 实时
      async initRealTimeEchartData(appkey = 'USER_HDT6WC2Y8850') {
        let params = {
          appkey,
          count: 30
        }
      ...
      async addRealTimeEchartData(appkey = 'USER_HDT6WC2Y8850') {
        let params = {
          appkey,
          count: 1
        }
      ...
      // 历史
      async loadHistoryEchartData(appkey = 'USER_HDT6WC2Y8850_HISTORY') {
        let params = {
          appkey,
          count: 48
        }
      ...
      clickFlag(flag) {
        ...
        switch (flag) {
          case 0:
            this.flagState = 0
            this.paramsAppKey = 'USER_HDT6WC2Y8850'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850'
          ...
          case 1:
            this.flagState = 1
            this.paramsAppKey = 'USER_HDT6WC2Y8850_Lenovo WIFI Security'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_Lenovo WIFI Security_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_Lenovo WIFI Security'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
          case 2:
            ...
            this.paramsAppKey = 'USER_HDT6WC2Y8850_Warranty'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_Warranty_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_Warranty'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
          case 3:
            this.flagState = 3
            this.paramsAppKey = 'USER_HDT6WC2Y8850_System Update'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_System Update_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_System Update'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
          case 4:
            this.flagState = 4
            this.paramsAppKey = 'USER_HDT6WC2Y8850_Health & Support'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_Health & Support_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_Health & Support'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
          case 5:
            this.flagState = 5
            this.paramsAppKey = 'USER_HDT6WC2Y8850_Hardware Settings'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_Hardware Settings_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_Hardware Settings'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
          case 6:
            this.flagState = 6
            this.paramsAppKey = 'USER_HDT6WC2Y8850_Preferences Menu'
            this.paramsAppKeyHistory = 'USER_HDT6WC2Y8850_Preferences Menu_HISTORY'
            this.paramsAppKeyMap = 'USER_HDT6WC2Y8850_Preferences Menu'
            this.initRealTimeEchartData(this.paramsAppKey)
            this.loadHistoryEchartData(this.paramsAppKeyHistory)
            this.loadMapDataFromServer(this.paramsAppKeyMap)
            break
      ...
      async loadMapDataFromServer(appkey = 'USER_HDT6WC2Y8850') {
        let params = {
          appkey
        }
